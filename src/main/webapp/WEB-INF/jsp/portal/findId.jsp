            ...
            <main>
                <div class="min-h-screen pt-14">
                    <div class="flex min-h-[80vh]">
                        <div class="self-center shadow-md m-auto w-[450px] rounded bg-white align-center p-4 pt-5">
                            <div><img src="${servletPath}/image/logo.png" alt="logo" class="inline-block h-6"><span
                                    class="float-right">Find ID</span></div><input type="text"
                                class="w-full border m-1 p-1 h-10" placeholder="가입 시 등록한 이메일을 입력해주세요"
                                id="userEmailInput">
                            <div class="flex flex-col mt-5 gap-3"><button class="rounded p-2 text-white 
    Button_fullSize__custom
    Button_subColor__custom" id="findIdBtn">아이디 찾기</button><button class="rounded p-2 text-white 
    Button_fullSize__custom
    Button_grayColor" onclick="location.href='${servletPath}/login.do';">로그인화면으로 이동</button></div>
                            <div class="flex gap-2 text-sm float-right mt-2">
                                <div class="cursor-pointer" onclick="location.href='${servletPath}/findPw.do';">비밀번호 찾기
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="${servletPath}/js/findId.js"></script>
