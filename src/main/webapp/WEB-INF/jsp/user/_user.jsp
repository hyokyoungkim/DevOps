...
<%
    ...
    if (view == null) {  //로그인이 되었다면
        ...
        if (    pageId.indexOf("join.do") != -1
            ||  pageId.indexOf("isUsedId.do") != -1
            ||  pageId.indexOf("getCipher.do") != -1
            ||  pageId.indexOf("checkCipher.do") != -1
            ||  pageId.indexOf("isUsedNickname.do") != -1
            ||  pageId.indexOf("login.do") != -1
            ||  pageId.indexOf("findId.do") != -1
            ||  pageId.indexOf("findPassword.do") != -1 
            ||  pageId.indexOf("getUser.do") != -1       
            
            //개발을 위해 임시로 열어둔다
            ||  pageId.indexOf("logout.do") != -1 ||  pageId.indexOf("modifyUser.do") != -1 
            ||  pageId.indexOf("modifyPassword.do") != -1 ||  pageId.indexOf("isUsedPassword.do") != -1 
            ||  pageId.indexOf("withdrawal.do") != -1 ||  pageId.indexOf("getUser.do") != -1
            ) {  //얘만 예외로 풀어준다.  
            view = PageManager.callController(pageContext, session, request, response);
        }
    }
