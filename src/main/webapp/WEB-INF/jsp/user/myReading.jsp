...
<%@page contentType="text/html" pageEncoding="UTF-8" isELIgnored="false" %>
    ...
    <body>
                    ...
                    <div class="flex pt-5 m-auto desktop:max-w-7xl laptop:max-w-4xl tablet:max-w-3xl">
                        ...
                        <div class="w-full pl-5">
                            <table role="table" class="w-full text-center text-md">
                                <thead>
                                    <tr role="row">
                                        <th colspan="1" role="columnheader"
                                            ...
                                            앨범명</th>
                                        <th colspan="1" role="columnheader"
                                            class="pt-3 pb-3 border-b-2 border-b-gray-300">첫
                                            열람 날짜</th>
                                        <th colspan="1" role="columnheader"
                                            class="pt-3 pb-3 border-b-2 border-b-gray-300">
                                            최근 열람 날짜</th>
                                ...
                                <tbody role="rowgroup" id="readingList">
        ...
        <script src="${servletPath}/js/myReading.js"></script>
        ...
        <script>
            ...
            document.addEventListener('click', clickDeleteBtn);
        </script>
    </body>
