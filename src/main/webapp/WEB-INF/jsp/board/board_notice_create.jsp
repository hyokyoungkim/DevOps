...
<%@page contentType="text/html" pageEncoding="UTF-8" isELIgnored="false" %>
    ...
    <body>
                ...
                <div class="min-h-screen pt-14">
                    <div class="flex pt-5 m-auto desktop:max-w-7xl laptop:max-w-4xl tablet:max-w-3xl">
                        ...
                        <div class="w-full desktop:pl-5 laptop:pl-5">
                            <div class="Title_box__custom">공지사항</div><input type="text"
                            ...
                            <div class="flex gap-10">
                                <h4>파일 첨부</h4>
                                <div class="tablet:w-[400px]">
                                    <input type="file" id="fileInput" class="tablet:w-full">
        ...
        <script src="${servletPath}/js/board_notice_create.js"></script>
