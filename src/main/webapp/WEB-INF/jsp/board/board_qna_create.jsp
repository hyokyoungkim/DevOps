...
<%@page contentType="text/html" pageEncoding="UTF-8" isELIgnored="false" %>
    ...
    <body>
                        ...
                        <nav class="min-w[150px] h-full border shadow rounded-sm w-40 tablet:hidden border-none">
                            ...
                            <div class="hidden tablet:block"><select name="" id=""
                                    ...
                                    <option value="/board/qna/list"
                                        onclick="location.href='${servletPath}/board_qna.do';">QnA</option>
                                </select></div>
                        </nav>
                        <div class="w-full desktop:pl-5 laptop:pl-5">
                            <div class="Title_box__custom">QnA</div><input type="text"
                                class="w-full h-10 p-1 my-4 border rounded " placeholder="제목을 입력하세요" id="titleInput">
                            <div class=" h-[400px]">
                                        ...
                                        <div class="wmde-markdown-var w-md-editor w-md-editor-show-live"
                                            ...
                                            <div class="w-md-editor-toolbar">
                                                ...
                                                <ul>
                                                    ...
                                                    <li class="active" id="bothView"><button type="button"
                                                            data-name="live" aria-label="Live code (ctrl + 8)"
                                                    ...
                                                    <li class="" id="rightView"><button type="button"
                                                            data-name="preview" aria-label="Preview code (ctrl + 9)"
                                                    ...
                                                    <li class="w-md-editor-toolbar-divider"></li>
                                                    <li class="" id="fullView"><button type="button"
                            ...
                            <div class="flex gap-10">
                                <h4>파일 첨부</h4>
                                <div class="tablet:w-[400px]"><input type="file" id="fileInput" class="tablet:w-full">
                                    <ul class="mt-3 h-[50px] overflow-y-auto" id="fileNameUl"></ul>
                                </div>
                            </div>
        ...
        <script src="${servletPath}/js/board_qna_create.js"></script>
        <script src="${servletPath}/js/markdownFunction.js"></script>
