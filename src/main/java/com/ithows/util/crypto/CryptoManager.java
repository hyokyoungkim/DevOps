...
public class CryptoManager {
	...
	public static String md5(String msg) throws NoSuchAlgorithmException {
		...
		return CryptoManager.byteToHexString(md.digest());
	}
	...
	public static String decryptAES256(String msg, String key) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeySpecException, InvalidAlgorithmParameterException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
        ...
        public static void AES128Test() throws Exception {
            ...
            String sKeyString = Hex.encodeHexString(skey.getEncoded());
            System.out.println("key string: " + skey.getEncoded());
		...
		String key = "!dptmdhdprtm2020";
		
		System.out.println("MD5 : " + plainText + " - " + CryptoManager.md5(plainText));
		System.out.println("SHA-256 : " + plainText + " - " + CryptoManager.sha256(plainText));
		
		String encrypted = CryptoManager.encryptAES256("Hello, World!", key);
		System.out.println("AES-256 : enc - " + encrypted);
		System.out.println("AES-256 : dec - " + CryptoManager.decryptAES256(encrypted, key));
	}
}