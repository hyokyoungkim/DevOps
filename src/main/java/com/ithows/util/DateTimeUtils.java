...
public class DateTimeUtils {
    ...
    public static String updateDeviceDateTime(String newTime){
        // newTime Format yyyyMMdd HH:mm:ss
...
//        commandLine[2] = "sudo date +\"%Y%m%d %T\" -s \"" + newTime + "\"";
    ...
    public static float getTimeDifference(String d2, String d1, int option) {  
        return getTimeDifference(d2, d1, "yyyy-MM-dd kk:mm:ss", option);
    }

    public static float getTimeDifference(String d2, String d1, String format, int option) {  
