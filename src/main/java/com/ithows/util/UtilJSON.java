        ...
        while (itr.hasNext()){
            try {
                ...
                if(jObj.get(key) instanceof JSONObject){
                    ...
                    List<ResultMap> arr = convertJSONArrayToArrayList((JSONArray)jObj.get(key));
                    map.put(key, arr);
                }else{
    ...
    public static JSONObject mapToJSon(Map<String, Object> payload){
        ...
        try {
            for(String keyVal : payload.keySet()) {
                Object value = payload.get(keyVal);
                jObj.put(keyVal, value != null? value : JSONObject.NULL);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            for(ResultMap element : list) {
                ...
                for (Object key : element.keySet()) {
                    ...
                    jObj.put((String) key, value != null? value : JSONObject.NULL);
                }
